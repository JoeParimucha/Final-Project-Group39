...
//Generates job for the graph by parsing info from the input file-----------------------------------------------------
...
//Breadth First Search For the Function--------------------------------------------------------------------------------------------
...
//Depth First Search For the Function--------------------------------------------------------------------------------------------
...
//Search function for the graph that searches with BFS or DFS-----------------------------------------------------
...
//Code generated by the Visual Studio Design Tools Starts Here---------------------------------------------------------------------------
...
//Code generated by the Visual Studio Design Tools Ends Here--------------------------------------------------------------------------------------------------------------
...
//Executed when the search button is clicked
	private: System::Void Search_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		//This and the code below for a while makes sure that the input box has only numbers and numbers that meet certain parameters---------------------------------------
			...
			if (clean == true && cleanPercentVariance == true) {
				...
				//Prints out a message if both of the traversals are selected at the same time-----------------------------------------------------------------
				if (BFSChecked == true && DFSChecked == true) {
					MessageBox::Show("Please Select BFS or DFS Only!");

				}

				//Runs if the user has BFS selected-----------------------------------------------------------------
				else if (BFSChecked == true) {
					bool BFSCh = true;
					int timeTakenI = 0;
					int& timeTaken = timeTakenI;

					//Changes the strings from system strings to normal strings so they can be read and changed to integers----------------------------------
					...
					//Prints out if the value inputted is too large-----------------------------------------------------------------
					...
					//Runs the rest of the code to search with BFS-----------------------------------------------------------------
						...
						//Sets all of the values to be printed out in the table------------------------------------------------------------
				...
				//Runs if the user has DFS selected to use-----------------------------------------------------------------
					...
					//Runs the rest of the code to search with DFS-----------------------------------------------------------------
					else {
						(*jobGraph).generate();
						std::vector<Job> jobVectorNew;
					...
					//Defaults to BFS and does not return the time if no boxes are selected-----------------------------------------------------------------
					bool BFSCh = true;
					int timeTakenI = 0;
					int& timeTaken = timeTakenI;
					...
					//Prints out this message if the numbers do not fall within the parameters-------------------------------------
					if (std::stoi(cleancheckBFSSearchBox) < 0 || std::stoi(cleancheckBFSSearchBox) > 320000) {
						MessageBox::Show("Please enter a number between 0 and 320,000");
					}

					//Runs the rest of the code to search with BFS as a default-----------------------------------------------------------------
					else {
						(*jobGraph).generate();
						BFSCh = true;
						std::vector<Job> jobVectorNew;
	...
	//Gives the user the ability to go the San Francisco City Government Job Website to look for jobs
